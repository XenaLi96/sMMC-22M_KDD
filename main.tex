...
\caption{\textbf{Combined release, benchmark-coverage, and provenance audit.}
The upper block preserves the release interface; the lower block partitions
the 99 unique samples into mutually exclusive provenance groups relative to
HEST-1K v1.1.0 and the 2025-02-12 STimage-1K4M snapshot. Counts are aligned
targets after QC.}
...
\textbf{Targets} &
\textbf{Coverage or provenance note} \\
\midrule
\rowcolor{gray!12}
...
DBiC-seq source block &
21 &
mouse / human cell-line origins &
DBiC-seq &
Native cell &
53,989 &
...
\midrule
\rowcolor{gray!12}
\multicolumn{7}{l}{\textit{Mutually exclusive provenance audit}} \\
...
Native cell &
53{,}989 &
Genuinely new primary data; 54{,}304 measured and 315 removed by QC \\
...
Gene targets are omitted from the combined manifest table for readability:
...
The combined audit in \Cref{tab:main_release_manifest} preserves the
benchmark-package overview and makes the new-versus-aggregated scale claim
directly auditable. The complete per-sample manifest remains in the appendix
and release package, where each source sample is linked to its platform, organ,
cell count, gene target, upstream source, license note, inclusion status, and
QC outcome.
...
categories.}
I-P/C-P/K-P are image/coordinate/KNN Gene Pearson; I-S is image Gene Spearman;
Cell-P is cell-wise Pearson. Bold entries mark the best Pearson baseline. H:
human; M: mouse; ZF: zebrafish; At: \textit{A. thaliana}; Sb: soybean.
Mouse-only rows are shaded.}
\label{tab:breadth_25}
\label{tab:breadth_25a}
\label{tab:breadth_25b}
\begin{tabular}{@{}lcrrrrrr@{}}
\toprule
Category & Sp. & I-P & C-P & K-P & I-S & Cell-P & F1 \\
\midrule
\rowcolor{mouseblue}\textbf{Bone} & M & .030 & \textbf{.124} & .055 & .037 & .180 & .240 \\
Brain & H+M & \textbf{.399} & .010 & .036 & .371 & .570 & .752 \\
Breast & H & \textbf{.400} & .053 & .035 & .375 & .433 & .487 \\
Cervical & H & \textbf{.178} & .017 & .014 & .157 & .247 & .026 \\
\rowcolor{mouseblue}\textbf{Colon} & M & \textbf{.615} & -.137 & .072 & .588 & .739 & .744 \\
Colorectal & H & \textbf{.431} & .056 & .083 & .419 & .532 & .623 \\
\rowcolor{mouseblue}\textbf{Embryo} & M & \textbf{.278} & .037 & .045 & .251 & .517 & .342 \\
Head & ZF & \textbf{.216} & .022 & .031 & .193 & .429 & .287 \\
Heart & H & \textbf{.292} & .010 & .021 & .266 & .688 & .304 \\
Kidney & H & \textbf{.402} & .019 & .017 & .361 & .471 & .460 \\
Liver & H & -.002 & .003 & \textbf{.010} & -.002 & .561 & .400 \\
Lung & H & \textbf{.359} & .065 & .053 & .317 & .402 & .457 \\
Lymph node & H & \textbf{.141} & .043 & .013 & .131 & .164 & .023 \\
Ovarian & H & \textbf{.250} & .122 & .104 & .239 & .312 & .234 \\
Ovarian gl. & H & \textbf{.402} & .059 & .043 & .391 & .559 & .756 \\
Pancreas & H & \textbf{.324} & .090 & .068 & .272 & .505 & .275 \\
Pancreatic & H & \textbf{.366} & .080 & .051 & .341 & .540 & .694 \\
Panc. duct gl. & H & \textbf{.331} & .091 & .100 & .282 & .408 & .386 \\
Plant & At & -.011 & .004 & \textbf{.012} & -.009 & .385 & .052 \\
Prostate & H & \textbf{.263} & -.015 & .025 & .244 & .263 & .083 \\
Seed & Sb & -.020 & -.003 & \textbf{.008} & -.018 & .314 & .037 \\
Skin & H & \textbf{.359} & .048 & .086 & .299 & .437 & .368 \\
\rowcolor{mouseblue}\textbf{Small intestine} & M & \textbf{.572} & -.104 & .067 & .548 & .701 & .715 \\
Tonsil & H & \textbf{.294} & .028 & .018 & .249 & .462 & .399 \\
Xenograft & H+M & \textbf{.387} & .041 & .049 & .362 & .526 & .589 \\
\midrule
\textbf{30-sample macro} & -- & \textbf{.324} & .046 & .053 &
\textbf{.291} & \textbf{.442} & \textbf{.413} \\
\bottomrule
\end{tabular}
\end{table}
