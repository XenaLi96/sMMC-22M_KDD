...
This appendix supports the main scale--resolution--context claims and documents
the release. Appendix~A defines intended use, licensing, and limitations.
Appendix~B records provenance for native Xenium cells, Visium HD derivatives,
and in-house DBiC-seq cells, together with construction, quality control, and
the released schema. Appendix~C provides construction-sensitivity,
sample/platform-transfer, biological-calibration, and pseudo-spot controls,
\methodname and protocol details, failure analyses, and context-aware use
cases. Appendix~D is the datasheet; Appendices~E and F state author
responsibility and reproducibility requirements.
...
\begin{tabularx}{\textwidth}{@{}X@{\hspace{1.2em}}X@{\hspace{1.2em}}X@{}}
\hyperref[sec:ethics]{\textbf{A}\enspace Ethical use, limitations, and licensing} &
\hyperref[sec:background]{\textbf{B}\enspace Provenance, construction, QC, and release schema} &
\hyperref[sec:supplementary_results]{\textbf{C}\enspace Validation, \methodname, and downstream analyses} \\
